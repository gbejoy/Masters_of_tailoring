...
function LandingPage()
{
    return (
        <div className="w-full h-full">
            ...
            <div className=" w-[25rem] flex flex-col gap-2 text-center items-center md:w-[35rem] absolute top-1/2 left-1/2 text-stone-100 -translate-x-1/2 -translate-y-1/2 backdrop-blur-[2px] p-2">
